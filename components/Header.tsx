...
export default function Header() {
  ...
  return (
    <header className=" bg-stone-100 dark:bg-stone-800 fixed w-full border-b-stone-700 dark:border-b-stone-100 z-3 border-b-1">
        ...
        (
          ...
          <div className="flex items-center gap-5">
            ...
            (
              ...
              >
                <SunIcon className="h-8 w-8 text-white opacity-0 hidden hover:scale-110 transition-transform hover:rotate-12 dark:inline-block dark:opacity-100"></SunIcon>
              </button>
            ) 
            : 
            (
        ...
        (
          <NavSide theme={theme} setTheme={setTheme} width={width}/>
        )}
